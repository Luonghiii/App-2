export const translations = {
  en: {
    ...
    install: "Install",
    shadowrocket: "Shadowrocket 2.2.72",
    locket: "Locket 2.8.0",
    
    // Module Card
    moduleConfigTitle: "Module Configuration",
    moduleNoteTitle: "Note",
    ...
    moduleSearchPlaceholder: "Search for a module...",
    moduleNoResults: "No modules found.",
    ...
    // LuonghiiiCard
    luonghiiiDescription: "Research / Educational module. Not for illegal purposes.",
    ...
    appGridButton: "Open / Get",
    appGridLoading: "Loading apps...",
    appGridSearchPlaceholder: "Search for an app...",
    appGridNoResults: "No apps found.",

    // Account Lock
    passwordPromptTitle: "Password Required",
    passwordPromptSubtitle: "Enter the password to view the account list.",
  ...
  vi: {
    ...
    notWorking: "Tạm ngưng",
    moduleSearchPlaceholder: "Tìm kiếm module...",
    moduleNoResults: "Không tìm thấy module nào.",
    modulesActive: "hoạt động",
    ...
    // LuonghiiiCard
    luonghiiiDescription: "Research / Educational module. Không dùng cho mục đích trái pháp luật",
    ...
    // App Grid
    appGridTitle: "Ứng dụng nổi bật",
    appGridButton: "Mở / Tải",
    appGridLoading: "Đang tải ứng dụng...",
    appGridSearchPlaceholder: "Tìm kiếm ứng dụng...",
    appGridNoResults: "Không tìm thấy ứng dụng nào.",

    // Account Lock
    passwordPromptTitle: "Yêu cầu Mật khẩu",
    passwordPromptSubtitle: "Nhập mật khẩu để xem danh sách tài khoản.",
    passwordPlaceholder: "Mật khẩu",
    unlockButton: "Mở khóa",
    incorrectPasswordError: "Mật khẩu không đúng. Vui lòng thử lại.",
  }
};
